...
program probe_method_c
  ...
  use mem_delaunay, only: nmd, nud, nwd, itab_wd
...
run_case() {
  ...
  "$FC" -o "probe_$name" "probe_$name.o" stubs.o max_dims.o consts_coms.o misc_coms.o mem_ijtabs.o mem_delaunay.o map_proj_gn.o map_proj_or.o map_proj_ps.o map_proj.o fill_itabs.o triangle_utils.o icosahedron.o expand_global.o spawn_nest.o
  set +e
