...
输入：真实 IGBP，NXP80
结论：全局越界数量在 W96 仍明显下降，但最坏角在 W64 后不再改善；按预注册规则属于分裂结论，而不是可以直接把默认预算提高到 W96。
...
- 正式 trace 为 schema v4，共 276,191 行、221,893,347 bytes（211.61 MiB）；新增预算诊断只有 192 条 pass summary 和 3 条 arm summary。
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| W32 | 11,017 | 17,302 | 28,319 | baseline | 28.113875 deg | 599,502.666 | 0.702859 / 0.831490 | 33,538 | 7,449 | 0 / 0 / 0 | 195.660 s |
| W64 | 10,418 | 16,536 | 26,954 | -1,365 (-4.820%) | 19.457635 deg | 485,855.336 | 0.731493 / 0.837030 | 34,914 | 7,460 | 0 / 0 / 0 | 380.309 s |
| W96 | 9,346 | 15,146 | 24,492 | -2,462 (-9.134%) | 19.457635 deg | 378,489.116 | 0.736460 / 0.844430 | 37,229 | 7,313 | 0 / 0 / 0 | 564.816 s |
...
2. 对最坏角，固定 persistent S3 `AngleKey` cohort，做局部 connectivity/patch POC；
...
整次 opt-in A/B 运行墙钟时间为 1,606.35 s。该时间包含三条诊断 arm、实际交付 W32 和全部 trace I/O，只是单次生产证据，不是性能保证。
