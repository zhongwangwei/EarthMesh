...
- cells: 14258 · vertices: 7132 · edges: 21387
- cell area (spherical km²): mean 3.5776e4, CV 0.730, max/min 71.32
- edge length (km): min 37.224, mean 258.974; max per-cell edge CV 0.277
- min angle: 30.00° · max angle: 119.89° · max angle deviation: 59.89° · max aspect: 2.00 · min compactness: 0.391
- local shape metric samples: 14258 · excluded coarse cells: 0
- local triangle quality: eta min 0.601 · NSR min 0.466
...
- cell sides: triangles 14258 · quads 0 · pentagons 0 · hexagons 0 · heptagons 0 · other 0
...
| min_angle_deg | 30.00407595008648 | pass |
| aspect_ratio_max | 1.997835455654236 | pass |
| cell_edge_length_cv_max | 0.27710636739810535 | pass |
| angle_deviation_deg_max | 59.889126027204 | warn |
| cell_area_cv | 0.7296377197617474 | pass |
| cell_area_ratio | 71.32122909995951 | pass |
...
|-------|-------|---------|-------------|---------------|-------------|-------------|
| 0 | 8198 | 0.059 | 0.101 | 12.772 | 0.962 | 0.959 |
| 1 | 6060 | 1.017 | 0.277 | 59.889 | 0.601 | 0.466 |
