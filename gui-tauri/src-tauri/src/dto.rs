...
pub(crate) struct ProjectSummary {
    ...
    pub(crate) refinement_algorithm: String,
    pub(crate) method_c_lepp_max_cycles: usize,
    pub(crate) method_c_lepp_target_size_tolerance: f64,
    pub(crate) method_c_lepp_maximum_neighbor_size_ratio: f64,
    pub(crate) method_c_lepp_maximum_vertices: usize,
    pub(crate) method_c_lepp_maximum_insertions_per_cycle: usize,
