...
pub fn ring_y_spans_at_slab_boundary(
    ring: &[(f64, f64)],
    boundary_x: f64,
    interior_x: f64,
...
pub fn ring_y_spans_at_x(ring: &[(f64, f64)], x: f64) -> Vec<(f64, f64)> {
    let mut ys = Vec::new();
...
pub fn triangle_y_span_at_x(triangle: &[(f64, f64)], x: f64) -> Option<(f64, f64)> {
