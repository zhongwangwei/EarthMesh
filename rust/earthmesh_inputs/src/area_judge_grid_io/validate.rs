...
pub fn validate_area_judge_grid_payload(payload: &AreaJudgeGridPayload) -> io::Result<()> {
...
pub fn validate_i32_matrix_shape(
    name: &str,
    rows: &[Vec<i32>],
    expected_rows: usize,
...
pub fn grid_covers_area_judge_bounds_one_based<T>(
    name: &str,
    grid: &[Vec<T>],
