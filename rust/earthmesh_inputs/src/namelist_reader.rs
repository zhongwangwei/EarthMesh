...
pub use earthmesh_core::NamelistAssignment;

pub fn namelist_assignments(contents: &str, section: &str) -> io::Result<Vec<NamelistAssignment>> {
...
pub fn native_grid_index(assignment: &NamelistAssignment, offset: usize) -> io::Result<usize> {
...
pub fn parse_namelist_string(value: &str) -> String {
    value
        .trim()
        .trim_end_matches(',')
        .trim()
...
pub fn parse_namelist_bool(field: &str, value: &str) -> io::Result<bool> {
...
pub fn parse_namelist_i32(field: &str, value: &str) -> io::Result<i32> {
...
pub fn parse_namelist_usize(field: &str, value: &str) -> io::Result<usize> {
...
pub fn parse_namelist_f64(field: &str, value: &str) -> io::Result<f64> {
