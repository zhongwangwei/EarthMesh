...
pub use crate::hydro_close_buffer::{
...
pub use crate::hydro_close_proximity::is_close_mask_ring_too_close;

pub fn geojson_close_mask_rings(
...
pub fn geojson_close_mask_lines(geometry: &BTreeMap<String, JsonNode>) -> Vec<Vec<(f64, f64)>> {
    let geometry_type = geometry
        .get("type")
        .and_then(JsonNode::as_str)
        .unwrap_or("");
