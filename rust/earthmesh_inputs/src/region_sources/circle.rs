...
pub fn read_method_c_circle_refinement_regions(
    source: &Path,
    refine: &RefineConfig,
    max_level: usize,
    nxp: usize,
...
pub fn push_method_c_circle_or_corridor_region_with_parent_halos(
    regions: &mut Vec<RefinementRegion>,
...
pub fn push_method_c_circle_or_corridor_region(
    regions: &mut Vec<RefinementRegion>,
    points: Vec<LonLatDegrees>,
    radius_meters: Vec<f64>,
    level: usize,
...
pub fn merge_refine_regions_by_shape(regions: &mut Vec<RefinementRegion>) {
...
pub fn read_method_c_calculated_circle_refinement_regions(
    source: &Path,
    max_level: usize,
