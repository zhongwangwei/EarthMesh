...
pub fn close_mask_netcdf_has_refine(inputfile: impl AsRef<Path>) -> io::Result<bool> {
...
pub fn validate_close_mask(mask: &CloseMask) -> io::Result<()> {
...
pub fn validate_close_mask_geographic(mask: &CloseMask) -> io::Result<()> {
