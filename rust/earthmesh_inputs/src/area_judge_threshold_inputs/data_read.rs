...
pub enum LatitudeOrder {
    NorthToSouth,
    SouthToNorth,
}

pub fn threshold_latitude_order(
    file: &netcdf::File,
    dimension_name: &str,
    expected_len: usize,
...
pub fn threshold_longitude_coordinates(
    file: &netcdf::File,
    dimension_name: &str,
    expected_len: usize,
...
pub fn numeric_missing_values(variable: &netcdf::Variable<'_>) -> io::Result<Vec<f64>> {
...
pub fn reject_invalid_threshold_values(
