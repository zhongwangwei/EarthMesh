...
//!
//! Three retained backends refine meshes, and they disagree about almost everything:
//! Method-C nests regions on a lattice, red-green splits marked triangles by
//! template, and CMRC conservatively coarsens a certified mother grid. What they share is upstream
...
//!         ↑
//! method_c   redgreen   certified    sibling backends
//! ```
//!
