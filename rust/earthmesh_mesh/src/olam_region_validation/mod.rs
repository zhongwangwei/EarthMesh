...
use crate::{
    validate_lonlat, validate_positive_distance, OlamRefinementRegion,
    OLAM_METHOD_C_MIN_GRID_SPACING_METERS,
};
...
pub(crate) fn validate_olam_method_c_radius(name: &str, value: f64) -> io::Result<()> {
