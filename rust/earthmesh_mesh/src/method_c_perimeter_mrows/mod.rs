    ...
    pub(crate) fn apply_method_c_perimeter_mrows(
        ...
        if ngr <= 1 {
            return Err(io::Error::new(
                ...
                "Method-C perimeter mrow NGR must be greater than one",
            ));
        }
        ...
        for iw in 2..=self.nwd {
            ...
            require_method_c_id("Method-C perimeter W neighbor", iw1, self.nwd)?;
            require_method_c_id("Method-C perimeter W neighbor", iw2, self.nwd)?;
            require_method_c_id("Method-C perimeter W neighbor", iw3, self.nwd)?;
        ...
        for im in 2..=self.nmd {
            ...
            {
                require_method_c_id("Method-C perimeter M W neighbor", iw, self.nwd)?;
