...
/// Canonical-style cache/update output for `MOD_grid_preprocess:TriMeshQuality`.
#[derive(Debug, Clone, PartialEq)]
pub struct TriangleMeshQualityCanonicalOutput {
...
///
/// Inputs use the repository's Rust convention for current Canonical-indexed
...
pub fn triangle_mesh_quality_metrics_indexed(
    cell_points: &[LonLatDegrees],
    cells_on_triangle: &[[usize; 3]],
    adjust_flags: &[bool],
    length_cache: &[[f64; 3]],
    angle_cache: &[[f64; 3]],
) -> Option<TriangleMeshQualityCanonicalOutput> {
    ...
    Some(TriangleMeshQualityCanonicalOutput {
