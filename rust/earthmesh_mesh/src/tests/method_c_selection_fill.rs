...
fn method_c_cart_hex_initializes_m_metadata_like_canonical() {
    let mesh = MethodCDelaunayMesh::from_cart_hex(2, 1000.0).expect("cart_hex Method-C mesh");
...
fn method_c_skips_cart_hex_periodic_copy_faces_like_canonical() {
    let mesh = MethodCDelaunayMesh::from_cart_hex(5, 1000.0).expect("cart_hex Method-C mesh");
