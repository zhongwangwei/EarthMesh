...
fn earth_runner_reads_inputs_and_writes_patchtype_info_and_final_gridfile() {
    ...
    let report = earthmesh_cli::mask_postproc_domain::run_mask_postproc_earth_domain(
        &plan,
        earthmesh_cli::mask_postproc_types::MaskPostprocEarthRunOptions {
            mask_sea_ratio: 0.4,
            minlon_dm_area: 10,
            maxlat_dm_area: 20,
            nlons_dm_select: 2,
...
fn earth_runner_rejects_non_earth_plan_before_writing_outputs() {
    ...
    .expect("land plan");
    let err = earthmesh_cli::mask_postproc_domain::run_mask_postproc_earth_domain(
        &plan,
        earthmesh_cli::mask_postproc_types::MaskPostprocEarthRunOptions {
            mask_sea_ratio: 0.4,
            minlon_dm_area: 10,
