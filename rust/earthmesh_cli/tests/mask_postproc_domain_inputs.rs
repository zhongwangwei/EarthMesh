...
fn read_mask_postproc_domain_inputs_loads_gridfile_contain_and_layout_from_plan_paths() {
    ...
    let plan = earthmesh_cli::plan_mask_postproc_domain_io(&root, 5, "tri", "landmesh", false)
    ...
    earthmesh_cli::write_unstructured_mesh_netcdf(&plan.source_gridfile, &mesh)
    ...
    let inputs = earthmesh_cli::read_mask_postproc_domain_inputs(&plan)
