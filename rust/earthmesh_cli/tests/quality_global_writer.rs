#[test]
fn quality_global_writer_preserves_fortran_schema_with_optional_qbx() {
    ...
    let quality = earthmesh_cli::GlobalQualityMesh {
        ...
        wbx: earthmesh_cli::QualityClassMetrics {
        ...
        lbx: earthmesh_cli::QualityClassMetrics {
        ...
        qbx: Some(earthmesh_cli::QualityClassMetrics {
...
fn quality_global_writer_rejects_wrong_class_width() {
    ...
    let err = earthmesh_cli::write_quality_global_netcdf(&output, &quality)
