...
const TABLE: &[(&str, &str, &str)] = &[
    ...
    ("hydro_wf.pick_mesh", "Mesh NetCDF (R7, optional)…", "Mesh NetCDF（R7，可选）…"),
    ("hydro_wf.pick_landtype", "Land-type NetCDF (R7, optional)…", "Land-type NetCDF（R7，可选）…"),
    ("hydro_wf.run", "Run hydro workflow", "运行 hydro 工作流"),
    ("hydro_wf.running", "running…", "运行中…"),
