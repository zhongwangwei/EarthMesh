...
pub use fair_pair_audit::{
    audit_transition_cell_pairs, repair_support_preflight, AnchorRepairDepth,
    AnchorRepairPortfolioEvidence, CellTopologyMergeSignature, FairPairAuditEvidence,
    PairPermanentRejectReason, PairRejectReason, RepairSupportPreflight,
    RepairSupportPreflightOutcome, RepairSupportRejectReason, TopologyPairClass,
    TopologyPairClassV2, TopologyPairKey, TopologyPairSignature,
};
...
pub use research_runner::{
    ...
    n12_lifted_sdce_gipc_audit_json, n12_lifted_sdce_incidence_contract_audit_json,
...
pub use sdce_gipc::{
    ...
    IncidencePlanCheckpoint, IncidencePlanEvidence, IncidencePlanOutcome, IncidencePlanOutcomeKind,
    IncidencePlanPartialState, IncidencePlanSearchConfig,
};
...
pub use transition_cell_v3::{
    ...
    DiskCellDomain, StratifiedTransitionDomainV3, StratifiedTransitionDomainV3Key,
    StratifiedV3Error, TopologyBoundaryKind, TransitionCellDomain,
};
