...
pub fn geojson_feature_nodes(root: &JsonNode) -> Vec<&JsonNode> {
    match root
        .as_object()
...
pub fn json_usize_f64_map_node(
    value: Option<&JsonNode>,
...
pub fn json_node_to_usize(value: &JsonNode) -> io::Result<usize> {
...
pub fn json_node_to_f64(value: &JsonNode) -> io::Result<f64> {
    let value = value
        .as_f64()
