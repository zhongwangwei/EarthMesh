...
pub fn cells_on_triangle_one_based_from_mesh(
...
pub fn triangles_on_cell_one_based_from_mesh(
    mesh: &UnstructuredMesh,
...
pub fn n_edges_on_cell_usize_from_mesh(mesh: &UnstructuredMesh) -> io::Result<Vec<usize>> {
    mesh.n_w_to_m
        .iter()
        .enumerate()
        .map(|(idx, value)| {
